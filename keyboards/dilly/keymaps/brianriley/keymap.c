...
#define KC_B_L2 LT(_FN2, KC_B)
#define KC_N_L5 LT(_FN5, KC_N)
#define KC_MALT MT(MOD_RALT, KC_M)
#define KC_BSPS MT(MOD_RSFT, KC_BSPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_ortho_3x10(
    ...
    KC_ACTL, KC_S,    KC_D,    KC_F_L3, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_ENT,
    KC_ZSFT, KC_XALT, KC_CGUI, KC_V_L4, KC_SPL1, KC_B_L2, KC_N_L5, KC_MALT, KC_COMM, KC_BSPS
  ),
  ...
  [_FN3] = LAYOUT_ortho_3x10(
    ...
    _______, _______, _______, _______, KC_BSPC, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
  ),

  [_FN4] = LAYOUT_ortho_3x10(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,
    KC_F11,  KC_F12,  _______, _______, _______, KC_LT,   KC_GT,   KC_QUES, KC_COLN, KC_DQUO,
    _______, _______, KC_GUIC, _______, KC_BSPC, _______, _______, _______, _______, _______
  ),
